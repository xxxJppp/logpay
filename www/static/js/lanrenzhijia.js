	...
	if (obj.length!=num.length){
		...
		for (var i=0; i<num.length; i++){
			 if(/Android|webOS|iPhone|iPod|BlackBerry/i.test(navigator.userAgent)) {
				obj[i].innerHTML = "<a target='_blank' href='mqqwpa://im/chat?chat_type=wpa&uin="+num[i]+"&version=1&src_type=web&web_src=logpay.cn'><img border='0' src='http://wpa.qq.com/pa?p=2:"+num[i]+":51' alt='点击咨询' title='点击咨询'/></a>"
		    } else {
