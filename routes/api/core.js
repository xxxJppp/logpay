...
// //     }
// //     let fee
// //     let  orderNumberFind = (orderNumber, uid, orderUid, payType, price, pay_price) =>{
// //         return new Promise((resolve, reject)=>{
// //             Order.findOne({orderNumber:orderNumber, uid:uid, orderUid:orderUid, payType:payType, price:price, pay_price:pay_price})
// //                  .then(order => resolve(order))
// //                  .catch(err => reject(err))
...
//         }
//     }
// //     // Order.findOne({ uid, orderNumber, orderUid, payType, pay_price, price, status:-1, expire: { $gte: 0, $lte: 300 }})
// //     //      .then(data=>{
// //     //     // 订单查询
// //     //     if (!data) {
// // 	// 		// 防止订单返回刷新生成订单但是orderNumber已存在且已付钱
// // 	// 		Order.findOne({orderNumber,status:2||1})
// // 	// 		      .then( order => {
// // 	// 				  if(order) {
// // 	// 					  return res.json('订单已支付!')
// // 	// 				  }
...
// Order.findOne({ uid, orderUid, payType, price, pay_price, status:-1})
// .then(data=>{
// //     //     // 订单查询
// //     //     if (!data) {
// //     //             // 验证签名
