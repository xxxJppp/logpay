   ...
   data() {
    ...
    methods: {
        alipay() {
                ...
                location.href = `http://logpay.paywz.cn/sdk/pay?price=${this.money}&payType=alipay&orderUid=${this.uid}&orderName=LogPay账户充值`
        },
        wxpay() {
             if(parseFloat(this.money)<=0) return false
                location.href = `http://logpay.paywz.cn/sdk/pay?price=${this.money}&payType=wxpay&orderUid=${this.uid}&orderName=LogPay账户充值`
        },
