   ...
   data() {
    ...
    methods: {
        alipay() {
                ...
                location.href = `http://129.204.199.91:9000/sdk/pay?price=${this.money}&payType=alipay&orderUid=${this.uid}&orderName=LogPay账户充值`
        },
        wxpay() {
             if(parseFloat(this.money)<=0) return false
                location.href = `http://129.204.199.91:9000/sdk/pay?price=${this.money}&payType=wxpay&orderUid=${this.uid}&orderName=LogPay账户充值`
        },
